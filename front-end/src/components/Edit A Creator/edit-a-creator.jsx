...
const EditCreator = () => {
    ...
    const handleSubmit = ()=> {
        ...
        const error = updateThisCreator(id);
        console.log(error);
        ...
        if (!error) {
            ...
            swal({
                icon: "warning",
                title: "Fail!",
                text: "Failing updating data! Please check and try again!"
            });
        } else {
            ...
            swal({
                icon: "success",
                title: "Success!",
                text: "Update this conten creator's info successfully!"
            });
        }
    ...
    const handleDelete = () => {
        ...
        if (!error) {
            ...
            swal({
                icon: "warning",
                title: "Fail!",
                text: "Failing deleting data! Please try again next time!"
            });
        } else {
            ...
            swal({
                icon: "success",
                title: "Success!",
                text: "Deleted this conten creator's info successfully!"
            });
        }
        navigate("/");
    }
