            ...
            <div className="display-area" id="details">
                ...
                <div className="individual-creator">
                    ...
                    <div className="individual-info">
                        ...
                        {
                            profile.youtubeLink &&
                            <a className="social-media-display" href={`https://www.youtube.com/${profile.youtubeLink}`} target="_blank" rel="noreferrer">
                                ...
                                <h5>@ {profile.youtubeLink}</h5>
                            </a>
                        }

                        {
                            profile.twitterLink &&
                            <a className="social-media-display" href={`https://www.x.com/${profile.twitterLink}`} target="_blank" rel="noreferrer">
                                ...
                                <h5>@ {profile.twitterLink}</h5>
                            </a>
                        }

                        {
                            profile.instagramLink &&
                            <a className="social-media-display" href={`https://www.instagram.com/${profile.instagramLink}`} target="_blank" rel="noreferrer">
